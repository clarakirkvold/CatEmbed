...
# Label information
ads_label = pd.read_csv('../test_react.csv')
...
result_df = pd.DataFrame({
    ...
    'ads_1': ads_label['ads_1'],
    'sites_1': ads_label['sites_1'],
...
x_test['ads_1'] = ads_label['ads_1']
y_test['ads_1'] = ads_label['ads_1']

# Get unique adsorbates
ad_list = y_test['ads_1'].unique()

# Evaluation loop

#os.makedirs(folder, exist_ok=True)  # Create folder if it doesn't exist
for ads in ad_list:
    x_split = x_test[x_test.ads_1 == ads].drop(columns=['ads_1'])
    y_split = y_test[x_test.ads_1 == ads].drop(columns=['ads_1'])
